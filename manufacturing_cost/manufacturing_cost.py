# -*- coding: utf-8 -*-
"""
  manufacturing_cost.py generated by WhatsOpt 1.8.2
"""
from optparse import OptionParser
from openmdao.api import Problem
from openmdao.api import NonlinearBlockGS, ScipyKrylov
# from openmdao_extensions.reckless_nonlinear_block_gs import RecklessNonlinearBlockGS
from manufacturing_cost.manufacturing_cost_base import ManufacturingCostBase, ManufacturingCostFactoryBase

class ManufacturingCost(ManufacturingCostBase):
    """ An OpenMDAO component to encapsulate ManufacturingCost analysis """
    def __init__(self, **kwargs):
        super(ManufacturingCost, self).__init__(**kwargs)
