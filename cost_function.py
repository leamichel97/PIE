# -*- coding: utf-8 -*-
"""
  cost_function.py generated by WhatsOpt 1.9.0
"""
from optparse import OptionParser
from openmdao.api import Problem
from openmdao.api import NonlinearBlockGS, ScipyKrylov
# from openmdao_extensions.reckless_nonlinear_block_gs import RecklessNonlinearBlockGS
from cost_function_base import CostFunctionBase, CostFunctionFactoryBase

class CostFunction(CostFunctionBase):
    """ An OpenMDAO component to encapsulate CostFunction analysis """
    def __init__(self, **kwargs):
        super(CostFunction, self).__init__(**kwargs)
    ...
    def setup(self):
        super(CostFunction, self).setup()


class CostFunctionFactory(CostFunctionFactoryBase):
    """ A factory to create disciplines of CostFunction analysis """
    pass
