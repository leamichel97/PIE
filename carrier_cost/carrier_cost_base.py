# -*- coding: utf-8 -*-
"""
  carrier_cost_base.py generated by WhatsOpt 1.8.2
"""
...
class CarrierCostBase(Group):
    ...
    def setup(self): 
        ...
        self.add_subsystem('Runway', self.create_runway(), promotes=['C_runway', 'ExtRunway', 'Launches', 'OnekmRunway', 'YearsRunway'])
        self.add_subsystem('RunwayMaintenance', self.create_runway_maintenance(), promotes=['CostRunwayMaint', 'C_RunwayMaint', 'Launches'])
