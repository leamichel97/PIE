...
class CostFunctionBase(Group):
    ...
    def setup(self): 
        ...
        self.add_subsystem('DevelopmentCost', self.create_development_cost(), promotes=['a', 'b', 'Cp', 'DD', 'f1', 'f10', 'f11', 'f3', 'FM1', 'HW', 'Ld', 'Mass', 'M_PA_percentage', 'Ns', 'STH'])
        ...
        self.add_subsystem('TotalCost', self.create_total_cost(), promotes=['CprodTotal', 'C_carrier', 'C_DO', 'C_IO', 'C_TOTAL'])
