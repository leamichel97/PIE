...
class CostFunctionBase(Group):
    ...
    def setup(self): 
        ...
        self.add_subsystem('DirectOperationCost', self.create_direct_operation_cost(), promotes=['Cf', 'Cox', 'Cpres', 'C_DO', 'C_PL', 'F', 'f11', 'f8', 'fc', 'fv', 'I', 'L', 'LpA', 'M0', 'Mp', 'Mpres', 'Ns', 'p', 'Q_N', 'r', 'Ts', 'W'])
